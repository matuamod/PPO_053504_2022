...
class NotificationUtil : Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        val nBuilder = getBasicNotificationBuilder(this, CHANNEL_ID_TIMER, true)

        val notificationIntent = Intent(this, TimerNotificationActionReceiver::class.java)
    ...
    companion object {
        // These two constants are for notification channels which we can use from API 26
        const val CHANNEL_ID_TIMER = "menu_timer"
        const val CHANNEL_NAME_TIMER = "Timer App Timer"
        // It describes the id of the notification itself
        ...
        // We want to control timer from Notifications
        // When the timer expires(timer finished) we want to be able to start the timer again
        ...
        fun showTimerRunning(context: Context, wakeUpTime: Long){
            ...
            nBuilder.setContentTitle("Timer is Running.")
                .setContentText("Current timer length is: ${PrefUtil.getSecondsRemaining(context)} sec")
                .setContentIntent(getPendingIntentWithStack(context, TimerActivity::class.java))
                .setOngoing(true)
        ...
        fun startNewTimer(context: Context) {
            val minutesRemaining = PrefUtil.getTimerLength(context)
            val secondsRemaining = minutesRemaining!! * 60L
            Log.d("NotificationUtil", "Seconds remaining: ${secondsRemaining}")
